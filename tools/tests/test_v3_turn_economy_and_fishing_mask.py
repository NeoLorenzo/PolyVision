...
class Phase1V3TurnEconomyTests(unittest.TestCase):
    ...
    def test_environment_version_and_handoff_state(self):
        ...
        self.assertEqual(self.env.PHASE1_ENVIRONMENT_VERSION, "v3_corrected_turn_economy")
        self.assertEqual(info.get("phase1_environment_version"), "v3_corrected_turn_economy")
